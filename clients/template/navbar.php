<div>
    ...
    <nav class="navbar navbar-expand-lg navbar-light">
        ...
        <div class="container-fluid">
            <!-- Navbar brand -->
            <a class="navbar-brand h2 logo" style="color: white; font-size: 3.5rem;
                font-weight: bold;" href="#"><img src="../assets/images/logo-white.svg" alt="logo" width="170px"
            height="170px"></a>

            <!-- Toggle button -->
            <button class="navbar-toggler" type="button" data-mdb-toggle="collapse" data-mdb-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24" color="#ffffff" fill="none">
                    <path d="M19 12C19 13.6569 17.6569 15 16 15C14.3431 15 13 13.6569 13 12C13 10.3431 14.3431 9 16 9C17.6569 9 19 10.3431 19 12Z" stroke="currentColor" stroke-width="1.5" />
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <!-- Dropdown -->
                    <li>
                        <a href="#" id="navbarDropdown" role="button" data-mdb-toggle="dropdown" aria-expanded="false">
