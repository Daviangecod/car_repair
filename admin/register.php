...
<section class="p-3 p-md-4 p-xl-3">
  <div class="container">
    <div class="row justify-content-center">
      <div class="col-12 col-md-9 col-lg-5 col-xl-8 col-xxl-8">
        <div class="card border border-light-subtle rounded-4">
          <div class="card-body p-3 p-md-4 p-xl-3">
              ...
              <div class="col-12">
                <div class="mb-5">
                  <div class="text-center mb-1">
                    <a href="#!" class="Bold text-decoration-none">
                      <h2 class="logo">D-Cars</h2>
                    </a>
                  </div>
            ...
            <div class="row">
              <div class="col-12">
                <hr class="mt-5 mb-2 border-secondary-subtle">
            ...
            <div class="row">
              <div class="col-12">
                <p class="col-12 mt-3 mb-2" style="text-align: center;">Or continue with</p>
