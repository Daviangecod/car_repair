        ...
        <main>
            <div class="container px-4">
                ...
                <div class="card shadow-sm mb-5 rounded w-full" style="overflow: hidden; cursor:pointer;">
                    ...
                    <form action="<?= baseUrl('admin/user/action/destroy.php') ?>" method="POST" enctype="multipart/form-data">

                        <input type="hidden" name="id" value="<?= isset($_GET['id']) ? $_GET['id'] : null ?>">

                        <div class="card-body">
                            <p class="mb-0">Are you sure you want to delete this user?</p>
                            <p class="mb-0 text-danger">Deleting a user will delete all related features</p>
                            <p class="text-danger">This features include, shops, services, languages, bookings, payment types</p>
                        ...
                        <div class="card-footer text-end">
                            <a href="<?= baseUrl('admin/user/index.php') ?>" class="btn btn-theme-primary">Cancel</a>
