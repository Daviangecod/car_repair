<?php $pageTitle = "Mechanic Shop Working Hours"; ?>
            ...
            <div class="container px-4">
                ...
                <div class="card mb-4">
                    <div class="card-header">
                        ...
                        <a href="<?= baseUrl('mechanic/hour/create.php') ?>" class="btn btn-theme-primary">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-plus-lg" viewBox="0 0 16 16">
                                <path fill-rule="evenodd" d="M8 2a.5.5 0 0 1 .5.5v5h5a.5.5 0 0 1 0 1h-5v5a.5.5 0 0 1-1 0v-5h-5a.5.5 0 0 1 0-1h5v-5A.5.5 0 0 1 8 2"/>
                            </svg>
                            <span class="d-inline-block ms-1">Add Working Hour</span>
                        </a>
                    </div>
                    <div class="card-body">
                                ...
                                <?php if(isset($workingHours) && count($workingHours) > 0): ?>
                                    ...
                                    <?php foreach($workingHours as $workingHour): ?>
                                        ...
                                        <tr class="text-center">
                                            ...
                                            <td><?= ($workingHour['closed'] == true) ? "Closed" : formatTime($workingHour['opening']) ?></td>
                                            <td><?= ($workingHour['closed'] == true) ? "Closed" : formatTime($workingHour['closing']) ?></td>
                                          
                                            <td>
                                                <?php 
                                                    $shop = [];
                                                    $shopId = $workingHour['shop_id'];
                                            ...
                                            <td><?= $workingHour['created_at'] ?></td>
                                            
                                           
                                            <td>
                                                <a href="<?= baseUrl('mechanic/hour/edit.php', ['id' => $workingHour['id']]) ?>" class="btn btn-sm btn-theme-primary">Edit</a>
                                                <a href="<?= baseUrl('mechanic/hour/delete.php', ['id' => $workingHour['id']]) ?>" class="btn btn-sm btn-danger">Delete</a>
                                            </td>
                                        </tr>
