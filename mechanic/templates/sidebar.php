     ...
     <nav class="sb-sidenav accordion bg-white" id="sidenavAccordion">
         <div class="sb-sidenav-menu mt-5">
             <div class="nav gap-2">
                 ...
                 <a class="nav-link text-black <?= strpos($hayStack, "mechanic/shop/index.php") ||  strpos($hayStack, "mechanic/shop/edit.php") ||  strpos($hayStack, "mechanic/shop/view.php")  ? 'active' : '' ?>" href="<?= baseUrl('mechanic/shop/') ?>">
                     <div class="sb-nav-link-icon">
