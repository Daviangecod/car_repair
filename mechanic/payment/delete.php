<?php $pageTitle = "Delete Payment Type"; ?>
        ...
        <main>
            <div class="container px-4">
                ...
                <div class="card shadow-sm mb-5 rounded w-full" style="overflow: hidden; cursor:pointer;">
                    ...
                    <form action="<?= baseUrl('mechanic/payment/action/destroy.php') ?>" method="POST" enctype="multipart/form-data">

                        <input type="hidden" name="id" value="<?= isset($_GET['id']) ? $_GET['id'] : null ?>">

                        <div class="card-body">
                            <p class="mb-0">Are you sure you want to delete this payment type?</p>
                        ...
                        <div class="card-footer text-end">
                            <a href="<?= baseUrl('mechanic/payment/index.php') ?>" class="btn btn-theme-primary">Cancel</a>
