              ...
              <div class="row gy-2 overflow-hidden">
                <div class="col-12">
                  <div class="form-floating mb-3">
                    <input type="username" class="form-control" name="username" id="username" placeholder="name@example.com" required>
                ...
                <div class="col-12">
                  <div class="d-grid my-3">
                    <button style="background-color:#1e2130; border:1px solid #1e2130;" class="btn btn-secondary btn-lg" type="submit">Sign in</button>
                  </div>
                </div>
                <div class="col-12">
